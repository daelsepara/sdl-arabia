...
bool characterScreen(SDL_Window *window, SDL_Renderer *renderer, Character::Base &player, Story::Base *story)
{
    ...
    if (window && renderer)
    {
        ...
        auto skills = createHeaderButton(window, "Skills", clrWH, intYW, headerw, headerh, space);
        auto possessions = createHeaderButton(window, "Possessions", clrWH, intYW, headerw, headerh, space);
